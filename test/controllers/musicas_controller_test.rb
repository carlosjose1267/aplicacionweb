...
class MusicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musica" do
    assert_difference("Musica.count") do
      post musicas_url, params: { musica: { bannerimg: @musica.bannerimg, demotitulo: @musica.demotitulo, titulo: @musica.titulo } }
    end
  ...
  test "should update musica" do
    patch musica_url(@musica), params: { musica: { bannerimg: @musica.bannerimg, demotitulo: @musica.demotitulo, titulo: @musica.titulo } }
